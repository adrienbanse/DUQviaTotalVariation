...
#
#
# def transform_envelope(envelope, var_noise, signature, method, params):
#
...
#
#
# def compute_max_envelope(envelope):
...
#         prob_gmm_region = 0
#
#         if check_if_region_is_bounded(region):
#             envelope = findHyperCubicEnvelope(region, method, params)
#             envelope = transform_envelope(envelope, var_noise, signature, method, params)
#
#             max_value = erf(compute_max_envelope(envelope) / (2 * sqrt(2)))
#
#         else:
#             max_value = 1
#
